#TODO this function is to get the number percntile of each DFC using above 97.5%, 95% and less than 5% and 2.5%
# the null distribution generated from the surrogates
import numpy as np
import scipy.stats as sc

def get_percentile_feats(num_areas,original_dfc,surrogate_dfc):
